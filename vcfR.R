...
OXTR_data <- extract.gt(OXTR, element = "GT", mask = FALSE, as.numeric = FALSE, return.alleles = FALSE, IDtoRowNames = TRUE, extract = TRUE, convertNA = TRUE)
...
# OXTR_chr2 <- melt(OXTR_data, id = c(chr2_57649859, chr2_57649912))

OXTR_chr2_57649912 <- OXTR_chr2[OXTR_chr2$Var1 == "chr2_57649912",]
