...
F_2011 <- fread("~/Downloads/GroupF2011_FocalData.txt")
...
F_2012 <- fread("~/Downloads/GroupF2012_FocalData.txt")
...
F_2013 <- fread("~/Downloads/GroupF2013_FocalData.txt")
...
F_2015 <- fread("~/Downloads/GroupF2015_FocalData.txt")
